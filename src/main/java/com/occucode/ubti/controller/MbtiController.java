...
public class MbtiController {
  ...
  public ResponseEntity<MbtiQuestionSubmitResponseDto> handleSubmitQuestionSelf(@RequestBody MbtiQuestionSubmitSelfRequestDto mbtiQuestionSubmitSelfRequestDto) throws JsonProcessingException {
    return new ResponseEntity<>(
  ...
  public ResponseEntity<MbtiQuestionSubmitResponseDto> handleSubmitQuestionFriend(@RequestBody MbtiQuestionSubmitFriendRequestDto mbtiQuestionSubmitFriendRequestDto) throws JsonProcessingException {
    return new ResponseEntity<>(
